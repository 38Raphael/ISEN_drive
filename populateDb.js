...
let uri = "mongodb+srv://ISENu:ISEN44drive@isendrive.kncnoyo.mongodb.net/?retryWrites=true&w=majority";
if (process.env.MONGODB_URI != null){
    tests("L'uri est bien trouvée, let's go!")
...
async function main() {
    ...
    debug(`Inserting data into database: ${dbName}`);
